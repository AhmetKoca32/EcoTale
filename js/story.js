...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const messages = [
    ...
    `Seninle birlikte çok eğlenceli bir hikaye oluşturacağım!`,
    "Hikayenin başına gelmeden önce, bilmen gereken bir şey var!",
    "Benim gibi bir yapay zeka bazen farklı formlara girebilir!",
    "Ve şimdi, dikkat et! Ekrana tıklarsan, benim nasıl farklı formlara girdiğimi görebilirsin. Tabii, dikkatini çok dağıtmayacak şekilde... belki biraz! ;) :)",
    "Hikayeyi dinlerken de eğlenebilirsin, ama sakin ol, hikayemizi unutma! ;) ",
    "Şimdi, hikayemize başlamak için hazırsan, seni bekliyorum...",
    "Hikaye başlıyor...",
